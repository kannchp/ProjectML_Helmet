...
# Paths
coco_path = 'dataset/valid/_annotations.coco.json'
yolo_label_dir = 'dataset/valid/labels_from_coco'
...
print(f"✓ Converted {count} images from COCO to YOLO format (valid set).")
